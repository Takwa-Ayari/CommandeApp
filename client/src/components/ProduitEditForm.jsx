    ...
    <div className="flex items-center justify-center">
        <form className="bg-slate-300 rounded-lg gap-6 p-8" onSubmit={handleSubmit}>
            ...
            <div className="flex flex-row items-end justify-end gap-2 mt-2">
                ...
                <button type="submit" className="text-green-700 hover:text-white border border-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Modifier</button>
            </div>
        </form>
    </div>
  );
